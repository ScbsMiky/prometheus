    ...
    <Frame screen="Services" title="Serviços">
      <ServicesStyled>
        ...
        <div style={{ display: "flex", alignItems: "center", flexWrap: "nowrap", overflow: "auto" }} className="categories">
          <BoxStyled onClick={( ) => setSelectedCategory({ id: "all", name: "Todos" })} data-variant={selectedCategory.id == "all" ? "blue" : "light"} style={{ display: "flex", alignItems: "center", marginRight: "0" }}>
            <span>Todos</span>
          </BoxStyled>

          {categories.map((category) => {
            return (
              <BoxStyled onClick={( ) => setSelectedCategory({ id: category.id, name: category.name })} key={category.id} data-variant={selectedCategory.id == category.id ? "blue" : "light"} style={{ display: "flex", alignItems: "center", marginRight: "0" }}>
        ...
        <BoxStyled onClick={( ) => setBlurNewCategory(true)} data-variant="blue" data-center="true">
        ...
        <div className="services">
          {services.map((service) => {
            return (
              <BoxStyled onClick={( ) => setSelectedService(service)} key={service.id} data-full="true">
        ...
        <BoxStyled onClick={( ) => setBlurNewService(true)} data-variant="blue" data-center="true">
        ...
        <Blur onClose={( ) => setBlurNewCategory(false)} activated={blurNewCategory}>
          <BoxStyled>
            ...
            <BoxStyled onClick={handleNewCategory} data-variant="blue" data-full="true" data-center="true">
              <span>Criar</span>
            </BoxStyled>
          </BoxStyled>
        </Blur>
        ...
        <Blur onClose={( ) => setBlurNewService(false)} activated={blurNewService}>
          <BoxStyled>
            ...
            <BoxStyled onClick={handleNewService} data-variant="blue" data-full="true" data-center="true">
              <span>Criar</span>
            </BoxStyled>
          </BoxStyled>
        </Blur>
        ...
        <Blur onClose={( ) => setSelectedService(undefined)} activated={!!selectedService}>
          {
            ...
            ? <BoxStyled>
                ...
                <BoxStyled onClick={handleDeleteService} data-variant="red" data-full="true" data-center="true">
                  <span>Deletar</span>
                </BoxStyled>

                <BoxStyled onClick={handleChangeService} data-variant="blue" data-full="true" data-center="true">
                  <span>Alterar</span>
                </BoxStyled>
              </BoxStyled>
            : <></>  
