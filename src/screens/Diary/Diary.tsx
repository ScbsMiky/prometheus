  ...
  return (
    <>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <BoxStyled data-variant={!dayList.days.includes(selectedDay) ? "blue" : "light"} onClick={( ) => handleChangeDay(false)}>
          <span>Sim</span>
        </BoxStyled>

        <BoxStyled data-variant={dayList.days.includes(selectedDay) ? "blue" : "light"} onClick={( ) => handleChangeDay(true)}>
          <span>Não</span>
        </BoxStyled>
      </div>
    </>
